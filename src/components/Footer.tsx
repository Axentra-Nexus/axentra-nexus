    ...
    <footer className="border-t border-border bg-[oklch(0.18_0.02_260)] text-background">
      <div className="container-max section-padding">
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col leading-tight">
                <span className="text-lg font-extrabold text-background">
                  Axentra<sup className="ml-0.5 text-[9px] font-semibold align-super">™</sup>
                </span>
                <span className="-mt-1 text-xs font-semibold uppercase tracking-[0.2em] text-primary">Nexus</span>
                <span className="mt-0.5 text-[9px] font-medium italic opacity-70">(a unit of Dharitha Nexus LLP)</span>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm opacity-70">
              ...
              <li><a href="tel:+919113513387" className="hover:text-primary transition-colors">+91-9113513387</a></li>
        ...
        <div className="mt-14 border-t border-background/10 pt-8">
          <p className="text-center text-[11px] leading-relaxed opacity-60 md:text-xs">
            All trademarks, trade names, logos, brand identities, and marketing assets associated with the name <span className="font-semibold opacity-90">"Axentra Nexus"</span>, whether registered or unregistered, shall be the exclusive intellectual property of <span className="font-semibold opacity-90">DHARITHA NEXUS LLP</span>.
          </p>
          <p className="mt-4 text-center text-xs opacity-50">
            © {new Date().getFullYear()} Dharitha Nexus LLP. All rights reserved. Axentra Nexus is a unit of Dharitha Nexus LLP.
          </p>
        </div>
      </div>
    </footer>
