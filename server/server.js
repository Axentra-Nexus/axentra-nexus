...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-CXI5obx0.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-BeNaxK7Q.js").then((n) => n.r),
...
var ROUTER_BASEPATH = "axentra-nexus";
var SERVER_FN_BASE = "/axentra-nexus/_serverFn/";
